...
describe 'user visits astronaut index' do
  ...
  it 'shows total time in space per each astronaut' do
    astronaut_1 = Astronaut.create(name: "Nick Lindy", age: 40, job: "Commander")
    mission_1 = astronaut_1.missions.create(title: "B Moon", time_in_space: 20)
    mission_2 = astronaut_1.missions.create(title: "A Moon", time_in_space: 30)
    astronaut_2 = Astronaut.create(name: "Nick Lindy", age: 40, job: "Commander")
    mission_3 = astronaut_2.missions.create(title: "B Moon", time_in_space: 40)
    mission_4 = astronaut_2.missions.create(title: "A Moon", time_in_space: 50)

    visit astronauts_path

    expect(page).to have_content("Total Time in Space: 50 days")
    expect(page).to have_content("Total Time in Space: 90 days")
  end
end
